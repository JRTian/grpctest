...
type ListRacesResponse struct {
	...
	Races []*RaceWithStatus `protobuf:"bytes,1,rep,name=races,proto3" json:"races,omitempty"`
}
...
func (x *ListRacesResponse) GetRaces() []*RaceWithStatus {
	if x != nil {
		return x.Races
	}
	return nil
...
type GetRaceResponse struct {
	...
	Race *RaceWithStatus `protobuf:"bytes,1,opt,name=race,proto3" json:"race,omitempty"`
}
...
func (x *GetRaceResponse) GetRace() *RaceWithStatus {
	if x != nil {
		return x.Race
	}
	return nil
...
type ListRacesRequestOrderBy struct {
	...
	OrderBy string `protobuf:"bytes,3,opt,name=order_by,json=orderBy,proto3" json:"order_by,omitempty"` // column name in race
...
func (x *ListRacesRequestOrderBy) GetOrderBy() string {
	if x != nil {
		return x.OrderBy
	}
	return ""
...
func (x *ListRacesRequestOrderBy) GetOrder() string {
	if x != nil {
		return x.Order
	}
	return ""
...
func (x *RaceWithStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RaceWithStatus) ProtoMessage() {}

func (x *RaceWithStatus) ProtoReflect() protoreflect.Message {
	mi := &file_racing_racing_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RaceWithStatus.ProtoReflect.Descriptor instead.
func (*RaceWithStatus) Descriptor() ([]byte, []int) {
	return file_racing_racing_proto_rawDescGZIP(), []int{7}
}

func (x *RaceWithStatus) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *RaceWithStatus) GetMeetingId() int64 {
	if x != nil {
		return x.MeetingId
	}
	return 0
...
func (x *RaceWithStatus) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *RaceWithStatus) GetNumber() int64 {
	if x != nil {
		return x.Number
	}
	return 0
...
func (x *RaceWithStatus) GetVisible() bool {
	if x != nil {
		return x.Visible
	}
	return false
...
func (x *RaceWithStatus) GetAdvertisedStartTime() *timestamppb.Timestamp {
	if x != nil {
		return x.AdvertisedStartTime
	}
	return nil
...
func (x *RaceWithStatus) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x5f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x62, 0x79, 0x22, 0x41, 0x0a, 0x11, 0x4c, 0x69, 0x73,
	0x74, 0x52, 0x61, 0x63, 0x65, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c,
	0x0a, 0x05, 0x72, 0x61, 0x63, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e,
	0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x57, 0x69, 0x74, 0x68, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x05, 0x72, 0x61, 0x63, 0x65, 0x73, 0x22, 0x20, 0x0a, 0x0e,
	...
	0x65, 0x12, 0x2a, 0x0a, 0x04, 0x72, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x16, 0x2e, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x57, 0x69, 0x74,
	0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x04, 0x72, 0x61, 0x63, 0x65, 0x22, 0x72, 0x0a,
	...
	,
	...
	0x65, 0x64, 0x53, 0x74, 0x61, 0x72, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xed, 0x01, 0x0a, 0x0e,
	0x52, 0x61, 0x63, 0x65, 0x57, 0x69, 0x74, 0x68, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x0e,
...
var file_racing_racing_proto_goTypes = []interface{}{
	...
	(*ListRacesRequestOrderBy)(nil), // 5: racing.ListRacesRequestOrderBy
	(*Race)(nil),                    // 6: racing.Race
	(*RaceWithStatus)(nil),          // 7: racing.RaceWithStatus
...
var file_racing_racing_proto_depIdxs = []int32{
	...
	5, // 1: racing.ListRacesRequest.order_by:type_name -> racing.ListRacesRequestOrderBy
	7, // 2: racing.ListRacesResponse.races:type_name -> racing.RaceWithStatus
	7, // 3: racing.GetRaceResponse.race:type_name -> racing.RaceWithStatus
	8, // 4: racing.Race.advertised_start_time:type_name -> google.protobuf.Timestamp
	8, // 5: racing.RaceWithStatus.advertised_start_time:type_name -> google.protobuf.Timestamp
	0, // 6: racing.Racing.ListRaces:input_type -> racing.ListRacesRequest
	2, // 7: racing.Racing.GetRace:input_type -> racing.GetRaceRequest
	1, // 8: racing.Racing.ListRaces:output_type -> racing.ListRacesResponse
	3, // 9: racing.Racing.GetRace:output_type -> racing.GetRaceResponse
